...
var utils = /*#__PURE__*/Object.freeze({
  ...
  RecolorableImageView: RecolorableImageView,
  RecolorableImageViewMixin: RecolorableImageViewMixin,
...
const { Button, ButtonMixin } = uki.utils.createMixinAndDefault({
  ...
  classDefFunc: SuperClass => {
    class Button extends RecolorableImageViewMixin(ThemeableMixin({
      SuperClass, defaultStyle: defaultStyle$2, className: 'UkiButton'
    })) {
      constructor (options) {
        super(options);
